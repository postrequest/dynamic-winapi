...
pub fn AccessCheck() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AccessCheck\0")) ) } )
}
pub fn AccessCheckAndAuditAlarmW() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AccessCheckAndAuditAlarmW\0")) ) } )
}
pub fn AccessCheckByType() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AccessCheckByType\0")) ) } )
}
pub fn AccessCheckByTypeResultList() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AccessCheckByTypeResultList\0")) ) } )
}
pub fn AccessCheckByTypeAndAuditAlarmW() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AccessCheckByTypeAndAuditAlarmW\0")) ) } )
}
pub fn AccessCheckByTypeResultListAndAuditAlarmW() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AccessCheckByTypeResultListAndAuditAlarmW\0")) ) } )
}
pub fn AccessCheckByTypeResultListAndAuditAlarmByHandleW() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AccessCheckByTypeResultListAndAuditAlarmByHandleW\0")) ) } )
}
pub fn AddAccessAllowedAce() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AddAccessAllowedAce\0")) ) } )
}
pub fn AddAccessAllowedAceEx() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AddAccessAllowedAceEx\0")) ) } )
}
pub fn AddAccessAllowedObjectAce() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AddAccessAllowedObjectAce\0")) ) } )
}
pub fn AddAccessDeniedAce() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AddAccessDeniedAce\0")) ) } )
}
pub fn AddAccessDeniedAceEx() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AddAccessDeniedAceEx\0")) ) } )
}
pub fn AddAccessDeniedObjectAce() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AddAccessDeniedObjectAce\0")) ) } )
}
pub fn AddAce() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AddAce\0")) ) } )
}
pub fn AddAuditAccessAce() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AddAuditAccessAce\0")) ) } )
}
pub fn AddAuditAccessAceEx() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AddAuditAccessAceEx\0")) ) } )
}
pub fn AddAuditAccessObjectAce() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AddAuditAccessObjectAce\0")) ) } )
}
pub fn AddMandatoryAce() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AddMandatoryAce\0")) ) } )
}
...
pub fn AdjustTokenGroups() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AdjustTokenGroups\0")) ) } )
}
pub fn AdjustTokenPrivileges() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AdjustTokenPrivileges\0")) ) } )
}
pub fn AllocateAndInitializeSid() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AllocateAndInitializeSid\0")) ) } )
}
pub fn AllocateLocallyUniqueId() -> Option<unsafe fn(
    Luid: PLUID,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AllocateLocallyUniqueId\0")) ) } )
}
pub fn AreAllAccessesGranted() -> Option<unsafe fn(
    GrantedAccess: DWORD,
    DesiredAccess: DWORD,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AreAllAccessesGranted\0")) ) } )
}
pub fn AreAnyAccessesGranted() -> Option<unsafe fn(
    GrantedAccess: DWORD,
    DesiredAccess: DWORD,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("AreAnyAccessesGranted\0")) ) } )
}
pub fn CheckTokenMembership() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("CheckTokenMembership\0")) ) } )
}
...
pub fn ConvertToAutoInheritPrivateObjectSecurity() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("ConvertToAutoInheritPrivateObjectSecurity\0")) ) } )
}
pub fn CopySid() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("CopySid\0")) ) } )
}
pub fn CreatePrivateObjectSecurity() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("CreatePrivateObjectSecurity\0")) ) } )
}
pub fn CreatePrivateObjectSecurityEx() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("CreatePrivateObjectSecurityEx\0")) ) } )
}
pub fn CreatePrivateObjectSecurityWithMultipleInheritance() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("CreatePrivateObjectSecurityWithMultipleInheritance\0")) ) } )
}
pub fn CreateRestrictedToken() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("CreateRestrictedToken\0")) ) } )
}
pub fn CreateWellKnownSid() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("CreateWellKnownSid\0")) ) } )
}
pub fn EqualDomainSid() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("EqualDomainSid\0")) ) } )
}
pub fn DeleteAce() -> Option<unsafe fn(
    pAcl: PACL,
    dwAceIndex: DWORD,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("DeleteAce\0")) ) } )
}
pub fn DestroyPrivateObjectSecurity() -> Option<unsafe fn(
    ObjectDescriptor: *mut PSECURITY_DESCRIPTOR,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("DestroyPrivateObjectSecurity\0")) ) } )
}
pub fn DuplicateToken() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("DuplicateToken\0")) ) } )
}
pub fn DuplicateTokenEx() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("DuplicateTokenEx\0")) ) } )
}
pub fn EqualPrefixSid() -> Option<unsafe fn(
    pSid1: PSID,
    pSid2: PSID,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("EqualPrefixSid\0")) ) } )
}
pub fn EqualSid() -> Option<unsafe fn(
    pSid1: PSID,
    pSid2: PSID,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("EqualSid\0")) ) } )
}
pub fn FindFirstFreeAce() -> Option<unsafe fn(
    pAcl: PACL,
    pAce: *mut LPVOID,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("FindFirstFreeAce\0")) ) } )
}
pub fn FreeSid() -> Option<unsafe fn(
    pSid: PSID,
) -> PVOID> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("FreeSid\0")) ) } )
}
pub fn GetAce() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetAce\0")) ) } )
}
pub fn GetAclInformation() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetAclInformation\0")) ) } )
}
pub fn GetFileSecurityW() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetFileSecurityW\0")) ) } )
}
pub fn GetKernelObjectSecurity() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetKernelObjectSecurity\0")) ) } )
}
pub fn GetLengthSid() -> Option<unsafe fn(
    pSid: PSID,
) -> DWORD> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetLengthSid\0")) ) } )
}
pub fn GetPrivateObjectSecurity() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetPrivateObjectSecurity\0")) ) } )
}
pub fn GetSecurityDescriptorControl() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetSecurityDescriptorControl\0")) ) } )
}
pub fn GetSecurityDescriptorDacl() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetSecurityDescriptorDacl\0")) ) } )
}
pub fn GetSecurityDescriptorGroup() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetSecurityDescriptorGroup\0")) ) } )
}
pub fn GetSecurityDescriptorLength() -> Option<unsafe fn(
    pSecurityDescriptor: PSECURITY_DESCRIPTOR,
) -> DWORD> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetSecurityDescriptorLength\0")) ) } )
}
pub fn GetSecurityDescriptorOwner() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetSecurityDescriptorOwner\0")) ) } )
}
pub fn GetSecurityDescriptorRMControl() -> Option<unsafe fn(
    SecurityDescriptor: PSECURITY_DESCRIPTOR,
    RMControl: PUCHAR,
) -> DWORD> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetSecurityDescriptorRMControl\0")) ) } )
}
pub fn GetSecurityDescriptorSacl() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetSecurityDescriptorSacl\0")) ) } )
}
pub fn GetSidIdentifierAuthority() -> Option<unsafe fn(
    pSid: PSID,
) -> PSID_IDENTIFIER_AUTHORITY> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetSidIdentifierAuthority\0")) ) } )
}
pub fn GetSidLengthRequired() -> Option<unsafe fn(
    nSubAuthorityCount: UCHAR,
) -> DWORD> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetSidLengthRequired\0")) ) } )
}
pub fn GetSidSubAuthority() -> Option<unsafe fn(
    pSid: PSID,
    nSubAuthority: DWORD,
) -> PDWORD> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetSidSubAuthority\0")) ) } )
}
pub fn GetSidSubAuthorityCount() -> Option<unsafe fn(
    pSid: PSID,
) -> PUCHAR> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetSidSubAuthorityCount\0")) ) } )
}
pub fn GetTokenInformation() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetTokenInformation\0")) ) } )
}
pub fn GetWindowsAccountDomainSid() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("GetWindowsAccountDomainSid\0")) ) } )
}
pub fn ImpersonateAnonymousToken() -> Option<unsafe fn(
    ThreadHandle: HANDLE,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("ImpersonateAnonymousToken\0")) ) } )
}
pub fn ImpersonateLoggedOnUser() -> Option<unsafe fn(
    hToken: HANDLE,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("ImpersonateLoggedOnUser\0")) ) } )
}
pub fn ImpersonateSelf() -> Option<unsafe fn(
    ImpersonationLevel: SECURITY_IMPERSONATION_LEVEL,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("ImpersonateSelf\0")) ) } )
}
pub fn InitializeAcl() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("InitializeAcl\0")) ) } )
}
pub fn InitializeSecurityDescriptor() -> Option<unsafe fn(
    pSecurityDescriptor: PSECURITY_DESCRIPTOR,
    dwRevision: DWORD,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("InitializeSecurityDescriptor\0")) ) } )
}
pub fn InitializeSid() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("InitializeSid\0")) ) } )
}
pub fn IsTokenRestricted() -> Option<unsafe fn(
    TokenHandle: HANDLE,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("IsTokenRestricted\0")) ) } )
}
pub fn IsValidAcl() -> Option<unsafe fn(
    pAcl: PACL,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("IsValidAcl\0")) ) } )
}
pub fn IsValidSecurityDescriptor() -> Option<unsafe fn(
    pSecurityDescriptor: PSECURITY_DESCRIPTOR,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("IsValidSecurityDescriptor\0")) ) } )
}
pub fn IsValidSid() -> Option<unsafe fn(
    pSid: PSID,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("IsValidSid\0")) ) } )
}
pub fn IsWellKnownSid() -> Option<unsafe fn(
    pSid: PSID,
    WellKnownSidType: WELL_KNOWN_SID_TYPE,
) -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("IsWellKnownSid\0")) ) } )
}
pub fn MakeAbsoluteSD() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("MakeAbsoluteSD\0")) ) } )
}
pub fn MakeSelfRelativeSD() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("MakeSelfRelativeSD\0")) ) } )
}
pub fn MapGenericMask() -> Option<unsafe fn(
    AccessMask: PDWORD,
    GenericMapping: PGENERIC_MAPPING,
)> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("MapGenericMask\0")) ) } )
}
pub fn ObjectCloseAuditAlarmW() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("ObjectCloseAuditAlarmW\0")) ) } )
}
pub fn ObjectDeleteAuditAlarmW() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("ObjectDeleteAuditAlarmW\0")) ) } )
}
pub fn ObjectOpenAuditAlarmW() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("ObjectOpenAuditAlarmW\0")) ) } )
}
pub fn ObjectPrivilegeAuditAlarmW() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("ObjectPrivilegeAuditAlarmW\0")) ) } )
}
pub fn PrivilegeCheck() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("PrivilegeCheck\0")) ) } )
}
pub fn PrivilegedServiceAuditAlarmW() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("PrivilegedServiceAuditAlarmW\0")) ) } )
}
pub fn QuerySecurityAccessMask() -> Option<unsafe fn(
    SecurityInformation: SECURITY_INFORMATION,
    DesiredAccess: LPDWORD,
)> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("QuerySecurityAccessMask\0")) ) } )
}
pub fn RevertToSelf() -> Option<unsafe fn() -> BOOL> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("RevertToSelf(\0")) ) } )
}
pub fn SetAclInformation() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("SetAclInformation\0")) ) } )
}
pub fn SetFileSecurityW() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("SetFileSecurityW\0")) ) } )
}
pub fn SetKernelObjectSecurity() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("SetKernelObjectSecurity\0")) ) } )
}
pub fn SetPrivateObjectSecurity() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("SetPrivateObjectSecurity\0")) ) } )
}
pub fn SetPrivateObjectSecurityEx() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("SetPrivateObjectSecurityEx\0")) ) } )
}
pub fn SetSecurityAccessMask() -> Option<unsafe fn(
    SecurityInformation: SECURITY_INFORMATION,
    DesiredAccess: LPDWORD,
)> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("SetSecurityAccessMask\0")) ) } )
}
pub fn SetSecurityDescriptorControl() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("SetSecurityDescriptorControl\0")) ) } )
}
pub fn SetSecurityDescriptorDacl() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("SetSecurityDescriptorDacl\0")) ) } )
}
pub fn SetSecurityDescriptorGroup() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("SetSecurityDescriptorGroup\0")) ) } )
}
pub fn SetSecurityDescriptorOwner() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("SetSecurityDescriptorOwner\0")) ) } )
}
pub fn SetSecurityDescriptorRMControl() -> Option<unsafe fn(
    pSecurityDescriptor: PSECURITY_DESCRIPTOR,
    RMControl: PUCHAR,
) -> DWORD> {
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("SetSecurityDescriptorRMControl\0")) ) } )
}
pub fn SetSecurityDescriptorSacl() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("SetSecurityDescriptorSacl\0")) ) } )
}
pub fn SetTokenInformation() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("SetTokenInformation\0")) ) } )
}
...
pub fn CveEventWrite() -> Option<unsafe fn(
    ...
    Some( unsafe { std::mem::transmute( get_advapi32_fn(obfstr::obfstr!("CveEventWrite\0")) ) } )
}
